      ...
      <div className="relative dark:bg-black bg-white w-full ">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-bold text-xl md:text-4xl dark:text-white text-black ">
            Remote{" "}
            <span className="text-neutral-600 mt-4">
        ...
        >
          <div className="bg-white dark:bg-black bg-opacity-40 dark:bg-opacity-50 p-6 rounded-lg shadow-xl max-w-xl text-center">
            ...
            <p className="text-justify md:text-lg text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            <p className="text-justify md:text-lg text-neutral-700 dark:text-neutral-300">
