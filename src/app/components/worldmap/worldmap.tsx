...
export function WorldMapDemo() {
  return (
    <>
      <div className="relative dark:bg-black  bg-gradient-to-r from-[#CACCD1] to-[#F3F4F7] w-full">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-bold text-xl md:text-4xl dark:text-white text-[#145874]">
            Remote{" "}
        ...
        {/* World Map */}
        <div className=" bg-gradient-to-r from-[#CACCD1] to-[#F3F4F7]">
        <WorldMap
          dots={[
            {
              start: {
            ...
            // Added Kathmandu and Nepal to the map
            {
            ...
            {
              start: { lat: 27.7172, lng: 85.3240 }, // Kathmandu, Nepal
              end: { lat: 40.7128, lng: -74.0060 }, // New York City
            },
          ]}
        /></div>
        {/* Mission & Vision */}
        ...
        >
          <div className="bg-white dark:bg-gray-700 bg-opacity-40 dark:bg-opacity-50 p-6 rounded-lg shadow-xl max-w-xl text-center">
            <h2 className="font-bold text-2xl md:text-3xl text-[#145874] dark:text-white mb-6">
              Our Mission
            </h2>
            <p className="text-base md:text-lg text-neutral-700 dark:text-neutral-300 mb-6">
              ...
              would blush. We’re here to innovate, iterate, and eliminate bugs – one pixel at a time!
            </p>

            <h2 className="font-bold text-2xl md:text-3xl text-[#145874] dark:text-white mb-8">
              Our Vision
            </h2>
